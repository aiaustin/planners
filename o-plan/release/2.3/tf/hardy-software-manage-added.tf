...
schema hardware_system; 
 vars
    ?e = ?(type installation_engineer);
 expands {hardware system}; 
 nodes
    1 action {prepare_computer_room},
    2 action {install_computer}; 
 orderings
    1 ---> 2; 
 conditions
    supervised {computer_room} = prepared at 2 from [1],
    unsupervised {status installation_engineer ?e} = unallocated at 1; 
 effects
    {status installation_engineer ?e} = allocated at begin_of 1,
    {status installation_engineer ?e} = unallocated at begin_of 2;
end_schema;
schema gen11;      ;;; HARDY generated
 expands {build common data dictionary system};
  only_use_for_effects
    {common data dictionary system} = completed;
end_schema;

schema gen12;      ;;; HARDY generated
 expands {perform user and clerical procedures};
  only_use_for_effects
    {user and clerical procedures} = completed;
end_schema;

schema gen13;      ;;; HARDY generated
 expands {assemble training material};
  only_use_for_effects
    {training material} = completed;
end_schema;

schema gen14;      ;;; HARDY generated
 expands {develop screen menu instructions for terminal operators};
  only_use_for_effects
    {screen menu instructions for terminal operators} = completed;
end_schema;

schema gen15;      ;;; HARDY generated
...
schema gen16;      ;;; HARDY generated
 expands {prepare_computer_room};
  only_use_for_effects
    {computer_room} = prepared;
end_schema;

schema gen17;      ;;; HARDY generated
